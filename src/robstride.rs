...
impl Into<ActuatorResponse> for crate::socketcan::CanFrame 
{
    fn into(mut self) -> ActuatorResponse {
        ...
        match mux {
            ...
            0x11 => ActuatorResponse::ReadParam(bytemuck::must_cast::<Self, ReadParamResponse>(self)),
...
pub fn actuator_can_id_from_response(frame: &crate::socketcan::CanFrame) -> u8 {
    ...
    match mux {
        ...
        0x11 => bytemuck::must_cast::<crate::socketcan::CanFrame, ReadParamResponse>(*frame).actuator_can_id as u8,
        _ => {
