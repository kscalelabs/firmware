...
impl RobstrideActuatorType {
    pub fn can_ranges(&self) -> RangeSet<f64> {
        RangeSet {
            ...
            angle: Range { min: u16::MIN as f64, max: u16::MAX as f64 },
            velocity: Range { min: u16::MIN as f64, max: u16::MAX as f64 },
            torque: Range { min: u16::MIN as f64, max: u16::MAX as f64 },
            kp:     Range { min: u16::MIN as f64, max: u16::MAX as f64 },
            kd:     Range { min: u16::MIN as f64, max: u16::MAX as f64 },
