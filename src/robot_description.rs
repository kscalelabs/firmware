    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            home_position: enum_map! {
                ActuatorId::Lsp => ActuatorCommand { qpos: 0.0, kp: 10.0, kd: 0.8284, ..Default::default() },
                ActuatorId::Lsr => ActuatorCommand { qpos: (10.0_f64).to_radians(), kp: 10.0, kd: 0.8257, ..Default::default() },
                ActuatorId::Lsy => ActuatorCommand { qpos: 0.0, kp: 4.0, kd: 0.0945, ..Default::default() },
                ActuatorId::Lep => ActuatorCommand { qpos: (-90.0_f64).to_radians(), kp: 4.0, kd: 0.1266, ..Default::default() },
                ActuatorId::Lwr => ActuatorCommand { qpos: 0.0, kp: 2.0, kd: 0.0295, ..Default::default() },

                ActuatorId::Rsp => ActuatorCommand { qpos: 0.0, kp: 10.0, kd: 0.8284, ..Default::default() },
                ActuatorId::Rsr => ActuatorCommand { qpos: (-10.0_f64).to_radians(), kp: 10.0, kd: 0.8257, ..Default::default() },
                ActuatorId::Rsy => ActuatorCommand { qpos: 0.0, kp: 4.0, kd: 0.0945, ..Default::default() },
                ActuatorId::Rep => ActuatorCommand { qpos: (90.0_f64).to_radians(), kp: 4.0, kd: 0.1266, ..Default::default() },
                ActuatorId::Rwr => ActuatorCommand { qpos: 0.0, kp: 2.0, kd: 0.0295, ..Default::default() },
