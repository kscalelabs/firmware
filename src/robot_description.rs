    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            home_position: enum_map! {
                ...
                ActuatorId::Lwg => ActuatorCommand { qpos: 0.0, kp: 4.0, kd: 0.06, ..Default::default() },
                ...
                ActuatorId::Rwg => ActuatorCommand { qpos: 0.0, kp: 4.0, kd: 0.06, ..Default::default() },
            ...
            policy_position: enum_map! {
                ...
                ActuatorId::Lwr => ActuatorCommand { qpos: 0.0, kp: 20.0, kd: 0.295, ..Default::default() },
                ActuatorId::Lwg => ActuatorCommand { qpos: 0.0, kp: 2.0, kd: 0.03, ..Default::default() },
                ...
                ActuatorId::Rwr => ActuatorCommand { qpos: 0.0, kp: 20.0, kd: 0.295, ..Default::default() },
                ActuatorId::Rwg => ActuatorCommand { qpos: 0.0, kp: 2.0, kd: 0.03, ..Default::default() },
