    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            home_position: enum_map! {
                ...
                ActuatorId::Lep => ActuatorCommand { qpos: (-90.0_f64).to_radians(), kp: 75, kd: 2.3, ..Default::default() },
                ...
                ActuatorId::Rep => ActuatorCommand { qpos: (90.0_f64).to_radians(), kp: 75, kd: 2.3, ..Default::default() },
