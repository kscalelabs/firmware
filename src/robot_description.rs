    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            home_position: enum_map! {
                ...
                ActuatorId::Lsr => ActuatorCommand { qpos: 0.0, kp: 100.0, kd: 8.257, ..Default::default() },
                ActuatorId::Lsy => ActuatorCommand { qpos: 0.0, kp: 40.0, kd: 0.945, ..Default::default() },
                ActuatorId::Lep => ActuatorCommand { qpos: 0.0, kp: 40.0, kd: 1.266, ..Default::default() },
                ...
                ActuatorId::Rsr => ActuatorCommand { qpos: 0.0, kp: 100.0, kd: 8.257, ..Default::default() },
                ActuatorId::Rsy => ActuatorCommand { qpos: 0.0, kp: 40.0, kd: 0.945, ..Default::default() },
                ActuatorId::Rep => ActuatorCommand { qpos: 0.0, kp: 40.0, kd: 1.266, ..Default::default() },
                ActuatorId::Rwr => ActuatorCommand { qpos: 0.0, kp: 20.0, kd: 0.295, ..Default::default() },

                ActuatorId::Lhp => ActuatorCommand { qpos: 0.0, kp: 150.0, kd: 24.722, ..Default::default() },
                ...
                ActuatorId::Lkp => ActuatorCommand { qpos: 0.0, kp: 150.0, kd: 8.654, ..Default::default() },
                ActuatorId::Lap => ActuatorCommand { qpos: 0.0, kp: 40.0, kd: 0.99, ..Default::default() },

                ActuatorId::Rhp => ActuatorCommand { qpos: 0.0, kp: 150.0, kd: 24.722, ..Default::default() },
                ...
                ActuatorId::Rkp => ActuatorCommand { qpos: 0.0, kp: 150.0, kd: 8.654, ..Default::default() },
                ActuatorId::Rap => ActuatorCommand { qpos: 0.0, kp: 40.0, kd: 0.99, ..Default::default() },
            },
            ...
            policy_position: enum_map! {
                ...
                ActuatorId::Lep => ActuatorCommand { qpos: 0.0, kp: 80.0, kd: 2.266, ..Default::default() },
                ActuatorId::Lwr => ActuatorCommand { qpos: 0.0, kp: 20.0, kd: 0.295, ..Default::default() },

                ActuatorId::Rsp => ActuatorCommand { qpos: 0.0, kp: 100.0, kd: 8.284, ..Default::default() },
                ActuatorId::Rsr => ActuatorCommand { qpos: 0.0, kp: 100.0, kd: 8.257, ..Default::default() },
                ActuatorId::Rsy => ActuatorCommand { qpos: 0.0, kp: 100.0, kd: 2.945, ..Default::default() },
                ActuatorId::Rep => ActuatorCommand { qpos: 0.0, kp: 100.0, kd: 2.266, ..Default::default() },
                ActuatorId::Rwr => ActuatorCommand { qpos: 0.0, kp: 20.0, kd: 0.295, ..Default::default() },
