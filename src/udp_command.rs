...
impl Default for UdpExtendedCommand {
    fn default() -> Self {
        Self {
            ...
            r_shoulder_pitch: (-15.0f32).to_radians(), r_shoulder_roll: 0.0, r_elbow_pitch: (90.0f32).to_radians(), r_elbow_roll: 0.0, r_wrist_roll: 0.0,
            l_shoulder_pitch: (15.0f32).to_radians(), l_shoulder_roll: 0.0, l_elbow_pitch: (-90.0f32).to_radians(), l_elbow_roll: 0.0, l_wrist_roll: 0.0,
